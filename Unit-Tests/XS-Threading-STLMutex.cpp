...
class XS_Threading_STLMutex: public Test
{
    public:
        
        XS_Threading_STLMutex( void ): mtx( false )
        {}
...
TEST_F( XS_Threading_STLMutex, TryLock )
{
...
TEST_F( XS_Threading_STLMutex, LockUnlock )
{
    mtx.Lock();
